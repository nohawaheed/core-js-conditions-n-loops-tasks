...
function convertNumberToString(numberStr) {
  ...
  for (let i = 0; i < numberStr.length; i += 1) {
    switch (numberStr[i]) {
      case '.':
      case ',':
        numberSentence += 'point';
        break;
      case '-':
        numberSentence += 'minus';
        break;
      case '0':
        numberSentence += 'zero';
        break;
      ...
      case '6':
        ...
        break;
      case '7':
        numberSentence += 'seven';
        break;
      case '8':
        numberSentence += 'eight';
        break;
      case '9':
        numberSentence += 'nine';
        break;
...
function getSpiralMatrix(size) {
  ...
  let num = 0;
  while (num <= size * size && top <= bottom && left <= right) {
...
function shuffleChar(str, iterations) {
  ...
  for (let i = 0; i < iterations; i += 1) {
    ...
    if (string === str) {
      const completedIterations = i + 1;
      return shuffleChar(str, iterations % completedIterations);
    }
  }
  return string;
}
